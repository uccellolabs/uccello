...
var Autoloader = function () {
    ...
    _createClass(Autoloader, [{
        ...
        value: function lazyLoad() {
            ...
            switch (page) {
                case 'list':
                    script = __webpack_require__("./resources/assets/js/core/list.js");
                    new script.List();
                    break;
            }
        }
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Datatable; });
...
__webpack_require__("./node_modules/datatables.net-buttons-bs/js/buttons.bootstrap.js");
__webpack_require__("./node_modules/datatables.net-colreorder/js/dataTables.colReorder.js");
__webpack_require__("./node_modules/datatables.net-fixedcolumns/js/dataTables.fixedColumns.js");
__webpack_require__("./node_modules/datatables.net-responsive-bs/js/responsive.bootstrap.js");
__webpack_require__("./node_modules/datatables.net-select/js/dataTables.select.js");
...
var Datatable = function () {
    ...
    _createClass(Datatable, [{
            ...
            $(selector).DataTable({
                ...
                createdRow: function createdRow(row, data, index) {
                    ...
                    $('td', row).click(function () {
                        document.location.href = this.rowUrl.Format(data.id);
                    });
                }
            });
        }
        ...
        key: 'getDatatableColumns',
        value: function getDatatableColumns() {
...
var List = function () {
    ...
    _createClass(List, [{
        ...
        value: function initDatatable() {
            ...
            var datatableGetDataUrl = $('meta[name="datatable-url"]').attr('content');

            var datatable = new __WEBPACK_IMPORTED_MODULE_0__datatable__["a" /* Datatable */]();
            datatable.url = datatableGetDataUrl + '?_token=' + csrfToken;
            datatable.columns = filterColumns;
            datatable.rowUrl = '/' + domainSlug + '/' + moduleName + '/detail?id={0}';
