...
/* WEBPACK VAR INJECTION */(function($) {__webpack_require__("./node_modules/datatables.net-bs/js/dataTables.bootstrap.js");
...
$(function () {
    ...
    function getDatatableColumns() {
        ...
        try {
            for (var _iterator = filterColumns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
