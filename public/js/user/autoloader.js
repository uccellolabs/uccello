(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/js/user/autoloader"],{
...
/***/ "./resources/assets/js/user/autoloader.js":
/*!************************************************!*\
  !*** ./resources/assets/js/user/autoloader.js ***!
  \************************************************/
/*! no exports provided */
...
/* harmony import */ var _user_account__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user-account */ "./resources/assets/js/user/user-account.js");
...
function () {
  ...
  _createClass(Autoloader, [{
    ...
    value: function lazyLoad() {
      ...
      switch (page) {
        case 'user-account':
          new _user_account__WEBPACK_IMPORTED_MODULE_0__["UserAccount"]();
          break;
      }
    }
  }]);
...
/***/ "./resources/assets/js/user/user-account.js":
/*!**************************************************!*\
  !*** ./resources/assets/js/user/user-account.js ***!
  \**************************************************/
...
function () {
  ...
  _createClass(UserAccount, [{
    key: "addAvatarTypeListener",
    value: function addAvatarTypeListener() {
      var container = $('#change_avatar');
      $('input[name="avatar_type"]', container).on('change', function (event) {
    ...
    key: "addAvatarSubmitButtonListener",
    value: function addAvatarSubmitButtonListener() {
      var _this = this;

      $('#avatar-submit').on('click', function (event) {
        $("#avatar-input").val(_this.canvasDataUrl);
    ...
    key: "initAvatarCropper",
    value: function initAvatarCropper() {
      var _this3 = this;

      var image = document.getElementById('avatar-image-preview');
      this.cropper = new cropperjs__WEBPACK_IMPORTED_MODULE_0___default.a(image, {
        aspectRatio: 1,
        autoCropArea: 1,
        ...
        crop: function crop(event) {
          var canvas = _this3.cropper.getCroppedCanvas(); // Convert image into data string


          _this3.canvasDataUrl = canvas.toDataURL();
          $("img.image").prop('src', _this3.canvasDataUrl);
        }
      });
    }
  }]);
...
/***/ 3:
/*!******************************************************!*\
  !*** multi ./resources/assets/js/user/autoloader.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! f:\VMs\Partage\ginkgo\packages\jerome-savin\uccello\resources\assets\js\user\autoloader.js */"./resources/assets/js/user/autoloader.js");
