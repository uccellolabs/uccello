...
return [
    ...
    'confirm' => [
        ...
        'button' => [
            ...
            'restore_record' => 'Restaurer cet enregistrement ?',
    ...
    'notification' => [
        'record' => [
            ...
            'restored' => 'L\'enregistrement a bien été restauré.',
        ],
        'relation' => [
    ...
    //Uitype 'entity'
    'entity' => [
        'confirmation_override' => "Cette entité est déjà liée à :name. 
                                    Si vous continuez, :name_ sera remplacé par l'entité actuelle."
    ]
];
