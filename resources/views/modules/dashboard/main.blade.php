...
@section('content')
    ...
    <main class="p-8">
        ...
        {{-- Navigation --}}
        <div class="" x-data="{open:1}">
            <div class="flex flex-row items-center text-gray-400">
                <div class="p-4 ml-6 cursor-pointer" x-on:click="open=1" :class="{'text-primary-900 border-b-2 border-primary-900 ':open===1}">Annual sales</div>
                <div class="p-4 ml-6 cursor-pointer" x-on:click="open=2" :class="{'text-primary-900 border-b-2 border-primary-900 ':open===2}">
                    <div class="flex flex-row items-center">
             ...
             {{-- Tab 1 --}}
        <div class="" x-show="open===1"></div>
            {{-- Tab 2 --}}
            <div class="" x-show="open===2">
                {{-- Dashboards content --}}
                <div class="p-8 z-0 flex items-center justify-center bg-white rounded-lg border border-gray-200" x-data="{open:false}">
                    {{-- Default bg --}}
