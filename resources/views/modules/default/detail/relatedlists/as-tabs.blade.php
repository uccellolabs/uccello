@section('relatedlist-tabs')
    @foreach ($module->relatedlists as $relatedlist)
        @continue(!empty($relatedlist->tab_id) || !$relatedlist->relatedModule->isActiveOnDomain($domain) || !Auth::user()->canRetrieve($domain, $relatedlist->relatedModule) || !$relatedlist->isVisibleAsTab)
