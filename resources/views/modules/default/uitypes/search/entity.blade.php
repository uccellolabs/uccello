<div class="form-group">
    <div class="form-line">
        ...
        ?>
        <select class="form-control field-search" multiple data-live-search="true" @if ($autocompleteSearch) data-abs-ajax-url="{{ ucroute('uccello.autocomplete', $domain, $relatedModule) }}"@endif>
