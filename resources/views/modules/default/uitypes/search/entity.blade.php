<div class="form-group">
    <div class="form-line">
        ...
        ?>
        <select class="field-search" data-constrain-width="false" multiple data-live-search="true" @if ($autocompleteSearch) data-abs-ajax-url="{{ ucroute('uccello.autocomplete', $domain, $relatedModule) }}"@endif>
